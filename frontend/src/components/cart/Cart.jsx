        ...
        <div className="fixed top-0 right-0 min-h-full w-[25%] bg-white flex flex-col justify-between shadow-sm">
            ...
            <div className="px-5 mb-3">
                ...
                <Link to="/checkout">
                    ...
                    <h1 className='text-[#fff] text-[18px] font-[600]'>Checkout Now (IND₹4999) </h1>
                    </div>
                </Link>
            </div>
        </div>
    ...
    return (
        <div className='border-b p-4'>
            <div className='w-full flex items-center'>
                <div>
                <div className={`bg-[#e44343] border border-[#e4434473] rounded-full w-[25px] h-[25px] ${styles.noramlFlex} justify-center cursor-pointer` }
